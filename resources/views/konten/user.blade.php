                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" id="edit" data-bs-toggle="modal"
                                                    ...
                                                    data-role="{{ $user->role }}" data-outlet="{{ $user->id_outlet }}"">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('edit_user') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Nama</label>
                            <input type="text" class="form-control" id="namae" name="nama" placeholder="Nama">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Username</label>
                            <input type="text" class="form-control" id="usne" name="username" placeholder="Username">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Password</label>
                            <input type="text" class="form-control" name="password" placeholder="Password">
                            <span class="text-danger" style="font-size:10px">*Kosongkan jika password tidak ingin diganti</span>
                        </div>
                        <div class="mb-3">
                            <div class="form-label">Role</div>
                            <select class="form-select" id="rolee" name="role">
                                <option value="admin" {{ isset($user) && $user->jenis == 'admin' ? 'selected' : '' }}>Admin</option>
                                <option value="kasir" {{ isset($user) && $user->jenis == 'kasir' ? 'selected' : '' }}>Kasir</option>
                                <option value="owner" {{ isset($user) && $user->jenis == 'owner' ? 'selected' : '' }}>Owner</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <div class="form-label">Outlet</div>
