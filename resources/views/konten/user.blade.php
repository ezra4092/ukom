            ...
            <div class="modal-content">
                ...
                <form action="{{ route('hapus_user') }}" method="POST">
                    ...
                    <div class="modal-body text-center mt-5 py-4">
                        <h3>Apakah anda yakin ingin menghapus data pelanggan <span id="namaa"
                                class="text-danger"></span>? Tindakan ini akan menghapus permanen semua data terkait
                            transaksi tanpa bisa dikembalikan.</h3>
                    </div>
                    <div class="modal-footer">
                        <div class="w-100">
                            <div class="row">
