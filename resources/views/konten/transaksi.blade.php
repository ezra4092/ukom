                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="p-2 g-col-6  ms-auto">
                            ...
                            @endif
                            <a href="{{ route('export_transaksi') }}" class="btn bg-success-lt">
                                        ...
                                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'kasir')
                                            <td>
                                                ...
                                                <button type="button" id="edit" data-bs-toggle="modal"
                                                    ...
                                                    data-member="{{ $transaksi->id_member }}"
                        ...
                        <div class="mb-3">
                            ...
                            <div id="paket-container">
                                <div class="input-group mb-2 paket-item">
                                    ...
                                    <input type="number" class="form-control" name="qty[]" placeholder="Kilogram"
                ...
                <div class="modal-body">
                    <form action="{{ route('edit_transaksi') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <div class="form-label">Member</div>
                                <select class="form-select" name="id_member" id="membere" disabled>
                                    @foreach ($member as $m)
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <select class="form-select" name="status" required>
                                    <option value="baru"
                                        {{ isset($transaksi) && $transaksi->status == 'baru' ? 'selected' : '' }}>Baru
                                    </option>
                                    <option value="proses"
                                    ...
                                    <option value="diambil"
                                        {{ isset($transaksi) && $transaksi->status == 'diambil' ? 'selected' : '' }}>
                                        Diambil
                                    </option>
                                </select>
                            </div>
